...
## Configuration shell to be ran in the newly created chroot environment

## Update GRUB default options to allow boot from a ZFS pool
...
#Fix mkconfig errors, and switch root to sda
